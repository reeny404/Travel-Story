...
function SearchBar({
  ...
  return (
    <form
      className="relative flex justify-between w-11/12 h-10 p-3 bg-white text-sm rounded-lg shadow-default md:max-w-[544px] md:w-full md:h-12 md:p-4"
      ...
      <div className="flex items-center w-full gap-2 md:gap-3 ">
        ...
        {searchTerm && (
          <SvgIcon
            ...
            height={12}
            title="cancel"
            className="ml-1 cursor-pointer transition-transform duration-300 ease-in-out md:ml-2"
